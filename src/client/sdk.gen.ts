 ...
 * **Rate limit:** 50 requests per minute
 */
export const deleteApiV1ProductsBySku = <ThrowOnError extends boolean = false>(options: Options<DeleteApiV1ProductsBySkuData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteApiV1ProductsBySkuResponses, DeleteApiV1ProductsBySkuErrors, ThrowOnError>({
        security: [
            {
                name: 'X-API-Key',
                type: 'apiKey'
 ...
 * **Rate limit:** 100 requests per minute
 */
export const getApiV1OrdersCarriers = <ThrowOnError extends boolean = false>(options?: Options<GetApiV1OrdersCarriersData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetApiV1OrdersCarriersResponses, GetApiV1OrdersCarriersErrors, ThrowOnError>({
        responseType: 'json',
        security: [
            {
                name: 'X-API-Key',
 ...
 * **Rate limit:** 10 requests per minute
 */
export const getApiV1OrdersByOrderNumberInvoices = <ThrowOnError extends boolean = false>(options: Options<GetApiV1OrdersByOrderNumberInvoicesData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiV1OrdersByOrderNumberInvoicesResponses, GetApiV1OrdersByOrderNumberInvoicesErrors, ThrowOnError>({
        responseType: 'blob',
        security: [
            {
                name: 'X-API-Key',
