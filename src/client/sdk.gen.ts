 ...
 * Get all rejected product masters with their rejection reasons.
 */
...
export const getApiV1Brands = <ThrowOnError extends boolean = false>(options?: Options<GetApiV1BrandsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetApiV1BrandsResponses, unknown, ThrowOnError>({
        responseType: 'json',
        security: [
            {
                name: 'X-API-Key',
